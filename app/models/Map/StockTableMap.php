...
class StockTableMap extends TableMap
{
     ...
     */
    const COL_IDSHOP = 'stock.idShop';

    /**
     * the column name for the quantity field
     */
    const COL_QUANTITY = 'stock.quantity';

    /**
     * the column name for the idArticle field
     */
    const COL_IDARTICLE = 'stock.idArticle';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idshop', 'Quantity', 'Idarticle', ),
        self::TYPE_CAMELNAME     => array('idshop', 'quantity', 'idarticle', ),
        self::TYPE_COLNAME       => array(StockTableMap::COL_IDSHOP, StockTableMap::COL_QUANTITY, StockTableMap::COL_IDARTICLE, ),
        self::TYPE_FIELDNAME     => array('idShop', 'quantity', 'idArticle', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idshop' => 0, 'Quantity' => 1, 'Idarticle' => 2, ),
        self::TYPE_CAMELNAME     => array('idshop' => 0, 'quantity' => 1, 'idarticle' => 2, ),
        self::TYPE_COLNAME       => array(StockTableMap::COL_IDSHOP => 0, StockTableMap::COL_QUANTITY => 1, StockTableMap::COL_IDARTICLE => 2, ),
        self::TYPE_FIELDNAME     => array('idShop' => 0, 'quantity' => 1, 'idArticle' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addColumn('idShop', 'Idshop', 'INTEGER', true, null, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(StockTableMap::COL_IDSHOP);
            $criteria->addSelectColumn(StockTableMap::COL_QUANTITY);
            $criteria->addSelectColumn(StockTableMap::COL_IDARTICLE);
        } else {
