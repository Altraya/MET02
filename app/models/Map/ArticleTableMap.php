...
class ArticleTableMap extends TableMap
{
    ...
    /**
     * the column name for the priceHT field
     */
    const COL_PRICEHT = 'article.priceHT';

    /**
     * the column name for the size field
     */
    const COL_SIZE = 'article.size';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idarticle', 'Name', 'Description', 'Priceht', 'Size', ),
        self::TYPE_CAMELNAME     => array('idarticle', 'name', 'description', 'priceht', 'size', ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_IDARTICLE, ArticleTableMap::COL_NAME, ArticleTableMap::COL_DESCRIPTION, ArticleTableMap::COL_PRICEHT, ArticleTableMap::COL_SIZE, ),
        self::TYPE_FIELDNAME     => array('idArticle', 'name', 'description', 'priceHT', 'size', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idarticle' => 0, 'Name' => 1, 'Description' => 2, 'Priceht' => 3, 'Size' => 4, ),
        self::TYPE_CAMELNAME     => array('idarticle' => 0, 'name' => 1, 'description' => 2, 'priceht' => 3, 'size' => 4, ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_IDARTICLE => 0, ArticleTableMap::COL_NAME => 1, ArticleTableMap::COL_DESCRIPTION => 2, ArticleTableMap::COL_PRICEHT => 3, ArticleTableMap::COL_SIZE => 4, ),
        self::TYPE_FIELDNAME     => array('idArticle' => 0, 'name' => 1, 'description' => 2, 'priceHT' => 3, 'size' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('priceHT', 'Priceht', 'DECIMAL', true, 10, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArticleTableMap::COL_NAME);
            $criteria->addSelectColumn(ArticleTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(ArticleTableMap::COL_PRICEHT);
            $criteria->addSelectColumn(ArticleTableMap::COL_SIZE);
        } else {
            $criteria->addSelectColumn($alias . '.idArticle');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.description');
            $criteria->addSelectColumn($alias . '.priceHT');
