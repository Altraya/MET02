...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Iduser', 'Login', 'Password', 'Salt', 'Firstname', 'Lastname', ),
        self::TYPE_CAMELNAME     => array('iduser', 'login', 'password', 'salt', 'firstname', 'lastname', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_IDUSER, UserTableMap::COL_LOGIN, UserTableMap::COL_PASSWORD, UserTableMap::COL_SALT, UserTableMap::COL_FIRSTNAME, UserTableMap::COL_LASTNAME, ),
        self::TYPE_FIELDNAME     => array('idUser', 'login', 'password', 'salt', 'firstName', 'lastName', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Iduser' => 0, 'Login' => 1, 'Password' => 2, 'Salt' => 3, 'Firstname' => 4, 'Lastname' => 5, ),
        self::TYPE_CAMELNAME     => array('iduser' => 0, 'login' => 1, 'password' => 2, 'salt' => 3, 'firstname' => 4, 'lastname' => 5, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_IDUSER => 0, UserTableMap::COL_LOGIN => 1, UserTableMap::COL_PASSWORD => 2, UserTableMap::COL_SALT => 3, UserTableMap::COL_FIRSTNAME => 4, UserTableMap::COL_LASTNAME => 5, ),
        self::TYPE_FIELDNAME     => array('idUser' => 0, 'login' => 1, 'password' => 2, 'salt' => 3, 'firstName' => 4, 'lastName' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('login', 'Login', 'VARCHAR', true, 15, null);
