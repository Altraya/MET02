...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_IDCATEGORY = 'category.idCategory';
    ...
    /**
     * the column name for the percentTaxe field
     */
    const COL_PERCENTTAXE = 'category.percentTaxe';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idcategory', 'Name', 'Percenttaxe', ),
        self::TYPE_CAMELNAME     => array('idcategory', 'name', 'percenttaxe', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_IDCATEGORY, CategoryTableMap::COL_NAME, CategoryTableMap::COL_PERCENTTAXE, ),
        self::TYPE_FIELDNAME     => array('idCategory', 'name', 'percentTaxe', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idcategory' => 0, 'Name' => 1, 'Percenttaxe' => 2, ),
        self::TYPE_CAMELNAME     => array('idcategory' => 0, 'name' => 1, 'percenttaxe' => 2, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_IDCATEGORY => 0, CategoryTableMap::COL_NAME => 1, CategoryTableMap::COL_PERCENTTAXE => 2, ),
        self::TYPE_FIELDNAME     => array('idCategory' => 0, 'name' => 1, 'percentTaxe' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('percentTaxe', 'Percenttaxe', 'DECIMAL', true, null, null);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategoryTableMap::COL_IDCATEGORY);
            $criteria->addSelectColumn(CategoryTableMap::COL_NAME);
            $criteria->addSelectColumn(CategoryTableMap::COL_PERCENTTAXE);
        } else {
            $criteria->addSelectColumn($alias . '.idCategory');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.percentTaxe');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategoryTableMap::COL_IDCATEGORY, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategoryTableMap::COL_IDCATEGORY) && $criteria->keyContainsValue(CategoryTableMap::COL_IDCATEGORY) ) {
