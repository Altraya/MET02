...
abstract class Category implements ActiveRecordInterface
{
    ...
    /**
     * The value for the percenttaxe field.
     *
     * @var        string
     */
    protected $percenttaxe;
    ...
    /**
     * Get the [percenttaxe] column value.
     *
     * @return string
     */
    ...
    public function setIdcategory($v)
    {
        ...
        if ($this->idcategory !== $v) {
            $this->idcategory = $v;
            $this->modifiedColumns[CategoryTableMap::COL_IDCATEGORY] = true;
        }
    ...
    /**
     * Set the value of [percenttaxe] column.
     *
     * @param string $v new value
     * @return $this|\Category The current object (for fluent API support)
     */
    public function setPercenttaxe($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->percenttaxe !== $v) {
            $this->percenttaxe = $v;
            $this->modifiedColumns[CategoryTableMap::COL_PERCENTTAXE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategoryTableMap::translateFieldName('Idcategory', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryTableMap::translateFieldName('Percenttaxe', TableMap::TYPE_PHPNAME, $indexType)];
            $this->percenttaxe = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->idcategory) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CategoryTableMap::COL_IDCATEGORY . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CategoryTableMap::COL_IDCATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'idCategory';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_PERCENTTAXE)) {
            $modifiedColumns[':p' . $index++]  = 'percentTaxe';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'percentTaxe':
                        $stmt->bindValue($identifier, $this->percenttaxe, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setPercenttaxe($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_IDCATEGORY)) {
            $criteria->add(CategoryTableMap::COL_IDCATEGORY, $this->idcategory);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_NAME)) {
            $criteria->add(CategoryTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_PERCENTTAXE)) {
            $criteria->add(CategoryTableMap::COL_PERCENTTAXE, $this->percenttaxe);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPercenttaxe($this->getPercenttaxe());
        if ($makeNew) {
            $copyObj->setNew(true);
