...
use \Shop as ChildShop;
use \ShopQuery as ChildShopQuery;
use \Exception;
use \PDO;
use Map\ShopTableMap;
 ...
 *
 *
 * @method     ChildShopQuery orderByIdshop($order = Criteria::ASC) Order by the idShop column
 * @method     ChildShopQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildShopQuery groupByIdshop() Group by the idShop column
 * @method     ChildShopQuery groupByName() Group by the name column
 *
 ...
 *
 * @method     ChildShop findOneByIdshop(int $idShop) Return the first ChildShop filtered by the idShop column
 * @method     ChildShop findOneByName(string $name) Return the first ChildShop filtered by the name column *
 ...
 *
 * @method     ChildShop requireOneByIdshop(int $idShop) Return the first ChildShop filtered by the idShop column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildShop requireOneByName(string $name) Return the first ChildShop filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildShop[]|ObjectCollection findByIdshop(int $idShop) Return ChildShop objects filtered by the idShop column
 * @method     ChildShop[]|ObjectCollection findByName(string $name) Return ChildShop objects filtered by the name column
...
abstract class ShopQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\ShopQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Shop', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT idShop, name FROM shop WHERE idShop = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ShopTableMap::COL_IDSHOP, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ShopTableMap::COL_IDSHOP, $keys, Criteria::IN);
    }
    ...
    public function filterByIdshop($idshop = null, $comparison = null)
    {
        if (is_array($idshop)) {
            $useMinMax = false;
            if (isset($idshop['min'])) {
                $this->addUsingAlias(ShopTableMap::COL_IDSHOP, $idshop['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idshop['max'])) {
                $this->addUsingAlias(ShopTableMap::COL_IDSHOP, $idshop['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ShopTableMap::COL_IDSHOP, $idshop, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ShopTableMap::COL_NAME, $name, $comparison);
    }
    ...
    {
        if ($shop) {
            $this->addUsingAlias(ShopTableMap::COL_IDSHOP, $shop->getIdshop(), Criteria::NOT_EQUAL);
        }
