...
abstract class Article implements ActiveRecordInterface
{
    ...
    /**
     * The value for the priceht field.
     *
     * @var        string
     */
    protected $priceht;
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ArticleTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [priceht] column.
     *
     * @param string $v new value
     * @return $this|\Article The current object (for fluent API support)
     */
    public function setPriceht($v)
    {
        ...
        if ($this->priceht !== $v) {
            $this->priceht = $v;
            $this->modifiedColumns[ArticleTableMap::COL_PRICEHT] = true;
        }
    ...
    public function setSize($v)
    {
        ...
        if ($this->size !== $v) {
            $this->size = $v;
            $this->modifiedColumns[ArticleTableMap::COL_SIZE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticleTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArticleTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArticleTableMap::translateFieldName('Priceht', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceht = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArticleTableMap::translateFieldName('Size', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ArticleTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(ArticleTableMap::COL_PRICEHT)) {
            $modifiedColumns[':p' . $index++]  = 'priceHT';
        }
        if ($this->isColumnModified(ArticleTableMap::COL_SIZE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'description':
                        ...
                        break;
                    case 'priceHT':
                        $stmt->bindValue($identifier, $this->priceht, PDO::PARAM_STR);
                        break;
                    case 'size':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_NAME)) {
            $criteria->add(ArticleTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_DESCRIPTION)) {
            $criteria->add(ArticleTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_PRICEHT)) {
            $criteria->add(ArticleTableMap::COL_PRICEHT, $this->priceht);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_SIZE)) {
            $criteria->add(ArticleTableMap::COL_SIZE, $this->size);
        }
