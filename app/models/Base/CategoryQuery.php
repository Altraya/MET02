 ...
 *
 *
 * @method     ChildCategoryQuery orderByIdcategory($order = Criteria::ASC) Order by the idCategory column
 * @method     ChildCategoryQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildCategoryQuery orderByPercenttaxe($order = Criteria::ASC) Order by the percentTaxe column
 *
 * @method     ChildCategoryQuery groupByIdcategory() Group by the idCategory column
 * @method     ChildCategoryQuery groupByName() Group by the name column
 * @method     ChildCategoryQuery groupByPercenttaxe() Group by the percentTaxe column
 *
 ...
 *
 * @method     ChildCategory findOneByIdcategory(int $idCategory) Return the first ChildCategory filtered by the idCategory column
 * @method     ChildCategory findOneByName(string $name) Return the first ChildCategory filtered by the name column
 * @method     ChildCategory findOneByPercenttaxe(string $percentTaxe) Return the first ChildCategory filtered by the percentTaxe column *
 ...
 *
 * @method     ChildCategory requireOneByIdcategory(int $idCategory) Return the first ChildCategory filtered by the idCategory column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCategory requireOneByPercenttaxe(string $percentTaxe) Return the first ChildCategory filtered by the percentTaxe column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildCategory[]|ObjectCollection findByIdcategory(int $idCategory) Return ChildCategory objects filtered by the idCategory column
 * @method     ChildCategory[]|ObjectCollection findByName(string $name) Return ChildCategory objects filtered by the name column
 * @method     ChildCategory[]|ObjectCollection findByPercenttaxe(string $percentTaxe) Return ChildCategory objects filtered by the percentTaxe column
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT idCategory, name, percentTaxe FROM category WHERE idCategory = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_IDCATEGORY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_IDCATEGORY, $keys, Criteria::IN);
    }
    ...
    public function filterByIdcategory($idcategory = null, $comparison = null)
    {
        if (is_array($idcategory)) {
            ...
            if (isset($idcategory['min'])) {
                $this->addUsingAlias(CategoryTableMap::COL_IDCATEGORY, $idcategory['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idcategory['max'])) {
                $this->addUsingAlias(CategoryTableMap::COL_IDCATEGORY, $idcategory['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_IDCATEGORY, $idcategory, $comparison);
    }
    ...
    /**
     * Filter the query on the percentTaxe column
     *
     * Example usage:
     * <code>
     * $query->filterByPercenttaxe(1234); // WHERE percentTaxe = 1234
     * $query->filterByPercenttaxe(array(12, 34)); // WHERE percentTaxe IN (12, 34)
     * $query->filterByPercenttaxe(array('min' => 12)); // WHERE percentTaxe > 12
     * </code>
     *
     * @param     mixed $percenttaxe The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildCategoryQuery The current query, for fluid interface
     */
    public function filterByPercenttaxe($percenttaxe = null, $comparison = null)
    {
        if (is_array($percenttaxe)) {
            $useMinMax = false;
            if (isset($percenttaxe['min'])) {
                $this->addUsingAlias(CategoryTableMap::COL_PERCENTTAXE, $percenttaxe['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($percenttaxe['max'])) {
                $this->addUsingAlias(CategoryTableMap::COL_PERCENTTAXE, $percenttaxe['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_PERCENTTAXE, $percenttaxe, $comparison);
    }
    ...
    {
        if ($category) {
            $this->addUsingAlias(CategoryTableMap::COL_IDCATEGORY, $category->getIdcategory(), Criteria::NOT_EQUAL);
        }
