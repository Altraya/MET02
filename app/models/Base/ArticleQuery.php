 ...
 * @method     ChildArticleQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildArticleQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildArticleQuery orderByPriceht($order = Criteria::ASC) Order by the priceHT column
 * @method     ChildArticleQuery orderBySize($order = Criteria::ASC) Order by the size column
 *
 * @method     ChildArticleQuery groupByIdarticle() Group by the idArticle column
 * @method     ChildArticleQuery groupByName() Group by the name column
 * @method     ChildArticleQuery groupByDescription() Group by the description column
 * @method     ChildArticleQuery groupByPriceht() Group by the priceHT column
 * @method     ChildArticleQuery groupBySize() Group by the size column
 *
 ...
 * @method     ChildArticle findOneByName(string $name) Return the first ChildArticle filtered by the name column
 ...
 * @method     ChildArticle findOneByPriceht(string $priceHT) Return the first ChildArticle filtered by the priceHT column
 * @method     ChildArticle findOneBySize(string $size) Return the first ChildArticle filtered by the size column *
 ...
 * @method     ChildArticle requireOneByName(string $name) Return the first ChildArticle filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildArticle requireOneByPriceht(string $priceHT) Return the first ChildArticle filtered by the priceHT column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildArticle requireOneBySize(string $size) Return the first ChildArticle filtered by the size column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildArticle[]|ObjectCollection findByName(string $name) Return ChildArticle objects filtered by the name column
 ...
 * @method     ChildArticle[]|ObjectCollection findByPriceht(string $priceHT) Return ChildArticle objects filtered by the priceHT column
 * @method     ChildArticle[]|ObjectCollection findBySize(string $size) Return ChildArticle objects filtered by the size column
...
abstract class ArticleQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Article', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT idArticle, name, description, priceHT, size FROM article WHERE idArticle = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ArticleTableMap::COL_NAME, $name, $comparison);
    }
    ...
    /**
     * Filter the query on the priceHT column
     *
     * Example usage:
     * <code>
     * $query->filterByPriceht(1234); // WHERE priceHT = 1234
     * $query->filterByPriceht(array(12, 34)); // WHERE priceHT IN (12, 34)
     * $query->filterByPriceht(array('min' => 12)); // WHERE priceHT > 12
     * </code>
     *
    ...
    public function filterByPriceht($priceht = null, $comparison = null)
    {
        if (is_array($priceht)) {
            ...
            if (isset($priceht['min'])) {
                $this->addUsingAlias(ArticleTableMap::COL_PRICEHT, $priceht['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($priceht['max'])) {
                $this->addUsingAlias(ArticleTableMap::COL_PRICEHT, $priceht['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ArticleTableMap::COL_PRICEHT, $priceht, $comparison);
    }
    ...
    public function filterBySize($size = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ArticleTableMap::COL_SIZE, $size, $comparison);
    }
